      ...
      <main className="max-w-6xl mx-auto px-4">
        <section className="py-24 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
            Search Autotrader, Bring a Trailer, and Cars & Bids in one place.
            Get daily updates, price drop alerts, and market analytics for the
            cars you care about.
          </p>
          <Link href="/signup">
        ...
        <section className="grid md:grid-cols-3 gap-8 pb-24">
          <div className="rounded-lg border border-border p-6">
            ...
            <p className="text-muted-foreground text-sm">
              Search by make, model, trim, year range, and location. We check
              Autotrader, BaT, and Cars & Bids daily.
            </p>
          </div>
          <div className="rounded-lg border border-border p-6">
